        ...
        val docRef = db.collection("ServiceList")
            ...
            .addOnSuccessListener { documents ->
                ...
                for (document in documents) {
                    ...
                    Log.d("documentFromFirebase", document.data.toString()+"-----id:"+document.id)
...
//                    give a false likeStatus when the first time load
                    Item( service.id,service.image, service.serviceName, service.description,service.likeStatus)
                }
