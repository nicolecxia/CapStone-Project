...
import com.example.cocygo.homeFragment.adapter.Item
...
//        viewModel.cartLists.observe(viewLifecycleOwner){ cartItems ->
//            //    update the lists likeStatus after got the user's liked services data
//            Log.d("observe cartLists","${cartItems}")
//            viewModel.updateItemsByCartList(cartItems)
//        }
    }
}